...
```{r}
# Load a single band
beirut_b5 <- raster("raster\\LC08_L1TP_174037_20180904_20180912_01_T1\\LC08_L1TP_174037_20180904_20180912_01_T1_B5.TIF")
```
...
beirut_b2 <- raster("raster\\LC08_L1TP_174037_20180904_20180912_01_T1\\LC08_L1TP_174037_20180904_20180912_01_T1_B2.TIF")
beirut_b3 <- raster("raster\\LC08_L1TP_174037_20180904_20180912_01_T1\\LC08_L1TP_174037_20180904_20180912_01_T1_B3.TIF")
beirut_b4 <- raster("raster\\LC08_L1TP_174037_20180904_20180912_01_T1\\LC08_L1TP_174037_20180904_20180912_01_T1_B4.TIF")

# Another way, is to list all files in a specific folder
rlistbeirut <-  list.files(path = paste(w,"\\raster\\LC08_L1TP_174037_20180904_20180912_01_T1", sep=""),  pattern="*.TIF$", full.names=TRUE) # create list with files
...
beirut_b10 <- raster("raster\\LC08_L1TP_174037_20180904_20180912_01_T1\\LC08_L1TP_174037_20180904_20180912_01_T1_B10.TIF")
...
beirut_b8 <- raster("raster\\LC08_L1TP_174037_20180904_20180912_01_T1\\LC08_L1TP_174037_20180904_20180912_01_T1_B8.TIF")
...
r1 <- raster("raster\\NTL\\VNP46A2.A2019100.h26v06.001.2021020141752_DNB_BRDF-Corrected_NTL.tif")
r2 <- raster("raster\\NTL\\VNP46A2.A2019100.h26v07.001.2021020141743_DNB_BRDF-Corrected_NTL.tif")
...
writeRaster(rgbnSt1_crop, datatype="FLT4S", filename = "raster\\processed\\rgbnRaster.tif", format = "GTiff", overwrite=TRUE)
writeRaster(NIR_crop_ra, datatype="FLT4S", filename = "raster\\processed\\nirCropResamp.tif", format = "GTiff", overwrite=TRUE)
writeRaster(TIRS_crop, datatype="FLT4S", filename = "raster\\processed\\tirsCrop.tif", format = "GTiff", overwrite=TRUE)
writeRaster(panSharpen_ihs, datatype="FLT4S", filename = "raster\\processed\\panSharpen_ihs.tif", format = "GTiff", overwrite=TRUE)
writeRaster(panSharpen_pca, datatype="FLT4S", filename = "raster\\processed\\panSharpen_pca.tif", format = "GTiff", overwrite=TRUE)

# Export one single raster
writeRaster(rgbnSt1_crop[[1]], datatype="FLT4S", filename = "raster\\processed\\rgb_crop_B1.tif", format = "GTiff", overwrite=TRUE)
```
