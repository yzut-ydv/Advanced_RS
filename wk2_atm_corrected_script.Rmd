---
title: "Atmospheric correction and cloud masking"
author: "Yrneh Ulloa"
...
![Figure 1. Left: Bottom of Atmosphere scene. Right: Radiance values scene. Landsat 8. ](C:\\Users\\ulloa-to\\git\\Advanced_Remote_sensing_HM\\week_2\\images\\radiance_boa_l8.png)

Load the BOA-Landsat8 image as a 'rasterBrick'.

```{r, include=TRUE, eval=TRUE}
# import the corrected boa image
l8_boa_br <- raster("data/wk2_results/l8_boa_ref.tif")
```
