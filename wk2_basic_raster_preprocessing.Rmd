...
aoi <- st_read("data/vector", "aoi_beirut")
```
...
writeRaster(rgbnSt1_crop, datatype="FLT4S", filename = "data\\wk2_results\\wk2_rgbnRaster.tif", format = "GTiff", overwrite=TRUE)
writeRaster(NIR_crop_ra, datatype="FLT4S", filename = "data\\wk2_results\\wk2_nirCropResamp.tif", format = "GTiff", overwrite=TRUE)
writeRaster(TIRS_crop, datatype="FLT4S", filename = "data\\wk2_results\\wk2_tirsCrop.tif", format = "GTiff", overwrite=TRUE)
writeRaster(panSharpen_ihs, datatype="FLT4S", filename = "data\\wk3_results\\wk2_panSharpen_ihs.tif", format = "GTiff", overwrite=TRUE)
writeRaster(panSharpen_pca, datatype="FLT4S", filename = "data\\wk3_results\\wk2_panSharpen_pca.tif", format = "GTiff", overwrite=TRUE)

# Export one single raster
writeRaster(rgbnSt1_crop[[1]], datatype="FLT4S", filename = "data\\wk3_results\\wk2_rgb_crop_B1.tif", format = "GTiff", overwrite=TRUE)
```
